    ...
    return (
        <div className="min-h-screen w-full flex">
            ...
            <div className="hidden lg:flex lg:w-[55%] xl:w-[60%] relative bg-slate-900 overflow-hidden">
                ...
                <div className="relative z-20 flex flex-col justify-center items-center w-full h-full p-12 text-white">
                    ...
                    <div className="flex flex-col items-center justify-center space-y-8 max-w-md">
                        ...
                        <div className="w-32 h-32 flex items-center justify-center relative">
                            ...
                            <img src="/finansheet-mark-512.png" alt="FinanSheet Logo" className="w-full h-full object-contain relative z-10 drop-shadow-[0_0_30px_rgba(56,189,248,0.4)]" />
                        </div>
                ...
                {/* Corner accent - moved to not get cut off */}
            ...
            <div className="w-full lg:w-[45%] xl:w-[40%] flex items-center justify-center p-6 lg:p-12 relative bg-slate-900 text-white">
                ...
                {/* Form Container Box - Bento Grid Layout */}
                <div className="w-full max-w-md relative z-10 flex flex-col gap-4">
                    {/* Tile 1: Header */}
                    <div className="bg-slate-800/50 backdrop-blur-md border border-slate-700/50 rounded-2xl p-6 shadow-xl shadow-black/20 text-center lg:text-left">
                    ...
                    {/* Tile 2: Form */}
                    <div className="bg-slate-800/50 backdrop-blur-md border border-slate-700/50 rounded-2xl p-8 shadow-2xl shadow-black/30">
                        {children}
                    </div>
                </div>
            </div>
