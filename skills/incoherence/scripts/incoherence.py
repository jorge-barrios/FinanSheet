    ...
    if step_number == 3:
        return {
            "actions": [
                ...
                f"  Start: python3 {script_path} --step-number 4 --total-steps 21 --thoughts \"Dimension: {{letter}}\"",
            ],
    ...
    if step_number == 9:
        return {
            "actions": [
                ...
                f"  Start: python3 {script_path} --step-number 10 --total-steps 21 --thoughts \"Verifying: {{id}}\"",
            ],
    ...
    if step_number == 17:
        return {
            "actions": [
                ...
                f"  Start: python3 {script_path} --step-number 18 --total-steps 21 --thoughts \"FILE: {{file}}\"",
                "",
