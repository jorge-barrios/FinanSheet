...
Usage:
    ...
    python3 scripts/analyze.py --step 3 --total-steps 5 --confidence medium --iteration 2
"""
...
# Script path for invoke commands
...
def main():
    ...
    if args.step == 3:
        ...
        if args.confidence == "high":
            ...
            next_cmd = build_invoke_command(SCRIPT_PATH, step=4, total_steps=args.total_steps)
    ...
    if next_step <= args.total_steps:
        next_cmd = build_invoke_command(SCRIPT_PATH, step=next_step, total_steps=args.total_steps)
    else:
        next_cmd = None
