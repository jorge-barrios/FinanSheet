...
<invoke working-dir=".claude/skills/scripts" cmd="python3 -m skills.refactor.refactor --step 1 --total-steps 2 --n 10" />

| Argument        | Required | Description                            |
| --------------- | -------- | -------------------------------------- |
| `--step`        | Yes      | Current step (starts at 1)             |
| `--total-steps` | Yes      | Total steps (2 for current workflow)   |
