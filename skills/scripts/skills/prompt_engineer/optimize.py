...
STEPS = {
    1: {
        ...
        "actions": [
            ...
            "",
            "  Consider: reasoning gaps, input handling, output formatting,",
            "  behavioral issues, verification needs, example quality, clarity",
            "",
    ...
    2: {
        ...
        "read": [
            ...
            "references/prompt-engineering-multi-turn.md (if multi-turn patterns needed)",
            "references/prompt-engineering-subagents.md (if orchestration/subagents)",
            "references/prompt-engineering-hitl.md (if human oversight patterns needed)",
        ],
        "actions": [
            ...
            "  - For each: APPLICABLE (maps to which issue) or NOT APPLICABLE (1-2 word reason)",
