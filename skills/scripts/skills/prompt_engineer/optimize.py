...
STEPS = {
    1: {
        ...
        "actions": [
            ...
            "",
            "BLIND identification of improvement opportunities (quote line evidence):",
            "",
            "  Identify issues that could be addressed by prompt engineering techniques.",
            "  Quote specific lines as evidence for each issue.",
            "",
    ...
    2: {
        ...
        "read": [
            ...
            "references/prompt-engineering-multi-turn.md (if prompt spans multiple LLM turns)",
            "references/prompt-engineering-subagents.md (if prompt orchestrates parallel/specialized LLM calls)",
            "references/prompt-engineering-hitl.md (if prompt includes human approval gates or feedback loops)",
        ],
        "actions": [
            ...
            "  Using the Technique Selection Guide table in each reference file:",
            "  - Scan ALL techniques in the table",
            "  - For each: APPLICABLE (maps to which issue) or NOT APPLICABLE (brief reason)",
            "  - Pay special attention to techniques with 'Any task' or 'Any instruction' triggers",
            "    (these are foundational and apply regardless of identified issues)",
            "  This review is MANDATORY before proposing changes.",
            "",
            "Format each change:",
            "  === CHANGE N: [title] ===",
            "  Line: [numbers]",
            ...
            "  Total techniques reviewed: [N]",
            "  APPLICABLE: [list with issue mappings]",
            "  NOT APPLICABLE: [list with brief reasons]",
        ],
    },
    3: {
        "title": "Refine",
        ...
        "actions": [
            ...
            "",
            "  For each APPLICABLE technique, answer WITHOUT looking at your proposal:",
            ...
            "  Pick 3 techniques marked NOT APPLICABLE",
            "  For each: verify the trigger truly doesn't match the prompt",
            "  If any dismissal was wrong, add to APPLICABLE and propose change",
            "",
    ...
    4: {
        ...
        "actions": [
            ...
            "  From the Anti-Patterns section of each reference file you read:",
            "  - List each anti-pattern by name",
            "  - For each: [OK] or [FOUND at line X: description]",
            "",
    ...
    5: {
        ...
        "actions": [
            ...
            "  Re-check all anti-patterns from references against the MODIFIED prompt:",
            "  - For each anti-pattern: [OK] or [FOUND: specific instance]",
            "",
