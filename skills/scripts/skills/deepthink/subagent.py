...
STEPS = {
    1: {
        ...
        "brief": "Re-read shared context, step-back to relevant principles",
        "actions": [
    ...
    2: {
        "title": "Analogical Generation",
        "brief": "Self-generate relevant examples from your perspective",
        "actions": [
    ...
    3: {
        "title": "Planning",
        "brief": "Devise explicit plan before analysis",
        "actions": [
    ...
    4: {
        "title": "Analysis",
        "brief": "Execute plan with evidence grounding",
        "actions": [
    ...
    5: {
        ...
        "brief": "Verify claims through independent questioning",
        "actions": [
    ...
    6: {
        "title": "Perspective Contrast",
        "brief": "Steel-man the opposing view",
        "actions": [
    ...
    7: {
        "title": "Failure Modes",
        "brief": "Actionable failure analysis per proposal",
        "actions": [
    ...
    8: {
        ...
        "brief": "Structured output for parent aggregation",
        "actions": [
            ...
            "Use the EXACT tags below for clean parsing.",
            "",
            "OUTPUT FORMAT:",
            "```",
            "<subagent_output>",
            "",
            "<core_findings confidence='[HIGH|MEDIUM|LOW]'>",
