    ...
    if step == 1:
        ...
        return {
            ...
            "actions": [
                ...
                "  - Translation gaps (JSON vs MD mismatch)",
                "",
        ...
        return {
            ...
            "actions": [
                ...
                "  - Rewrite comment to remove change-relative language",
                "  - Use set-doc to add corrected comment:",
                "    python3 -m skills.planner.cli.plan --state-dir $STATE_DIR set-doc \\",
                "      --milestone M-001 --type function_block --function func \\",
                "      --content-file /tmp/fixed.txt --decision-ref DL-001",
                "    python3 -m skills.planner.cli.plan --state-dir $STATE_DIR set-doc \\",
                "      --milestone M-001 --type inline --location 'func:line' \\",
                "      --content-file /tmp/fixed.txt --decision-ref DL-001",
                "",
                "Missing WHY comments:",
                "  - Find Decision Log entry that explains the choice",
                "  - Add via set-doc:",
                "    python3 -m skills.planner.cli.plan --state-dir $STATE_DIR set-doc \\",
                "      --milestone M-001 --type function_block --function func \\",
                "      --content-file /tmp/why.txt --decision-ref DL-001",
                "    python3 -m skills.planner.cli.plan --state-dir $STATE_DIR set-doc \\",
                "      --milestone M-001 --type inline --location 'func:line' \\",
                "      --content-file /tmp/why.txt --decision-ref DL-001",
                "",
                ...
                "    {\"method\": \"set-doc\", \"params\": {\"milestone\": \"M-001\", \"type\": \"function_block\", \"function\": \"process\", \"content_file\": \"/tmp/fixed.txt\", \"decision_ref\": \"DL-001\"}, \"id\": 1},",
                "    {\"method\": \"set-doc\", \"params\": {\"milestone\": \"M-001\", \"type\": \"inline\", \"location\": \"func:42\", \"content_file\": \"/tmp/fixed2.txt\", \"decision_ref\": \"DL-001\"}, \"id\": 2},",
                "    {\"method\": \"set-doc\", \"params\": {\"milestone\": \"M-001\", \"type\": \"inline\", \"location\": \"func:58\", \"content_file\": \"/tmp/why.txt\", \"decision_ref\": \"DL-002\"}, \"id\": 3}",
                "  ]'",
                "",
                "COMMON FIX PATTERNS:",
                "",
                "Invalid decision_refs:",
                "  - Verify DL-XXX entries exist in decision_log",
                "  - Add missing decision_log entries first if needed",
                "",
                "Translation gaps:",
                "  - Fix the JSON content only. plan.md is regenerated automatically at the terminal gate.",
                "",
                "TEMPORAL REFERENCE:",
                temporal_resource,
                "",
