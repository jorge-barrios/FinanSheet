...
def get_step_3_guidance():
    ...
    return {
        ...
        "actions": [
            ...
            "",
            "Format each proposed change using this EXACT template:",
            "",
            ...
            "EXAMPLE (filled):",
            "",
            "=== CHANGE 1: Remove Hedging Language ===",
            "Line: 12-15",
            "Technique: Affirmative Directives",
            "Trigger: \"Prompt contains hedging phrases like 'might', 'could try'\"",
            "Effect: +15% task completion rate",
            "",
            "  BEFORE:",
            "  - you might want to consider using the helper function",
            "  - when you encounter this type of situation",
            "",
            "  AFTER:",
            "  + Use the helper function when you encounter this situation",
            "",
            "  [TRADEOFF] More direct tone; less perceived flexibility",
            "",
...
def get_step_7_guidance():
    ...
    return {
        ...
        "actions": [
            ...
            "================",
            "",
            "If 2+ changes, start with a summary table:",
            "",
            " #  | Line | Problem              | Technique            | Risk",
            "----+------+----------------------+----------------------+------",
            " 1  |   12 | Hedging language     | Affirmative Direct.  | Low",
            " 2  |   28 | Missing examples     | Few-Shot Prompting   | Med",
            "----+------+----------------------+----------------------+------",
            "",
