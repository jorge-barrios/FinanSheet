    ...
    if step_number == 2:
        return {
            "actions": [
                ...
                "   answer exists.",
                "",
                "   The distinguishing test: WHO BEARS THE CONSEQUENCE?",
                "   - Technical defaults (port numbers, encoding): Framework",
                "     authors bear responsibility. Safe to inherit.",
                "   - Policy defaults: User/org bears responsibility. These are",
                "     POLICY DECISIONS, not technical decisions.",
                "",
                "   Signals that trigger this category:",
                "   - Time-based values (retention, TTL, expiry, intervals)",
                "   - Quantity limits (max files, max size, quotas, thresholds)",
                "   - Behavioral strategies (block vs discard, rotation method,",
                "     retry policy, overflow handling)",
                "   - Format choices with operational implications",
                "",
                "   When ANY policy default is chosen, present alternatives and",
                ...
                "  |----------|----------|---------|----------------|",
                "  | Policy   | What configuration values am I choosing where |",
                "  |          | user/org bears operational consequence? Are |",
                "  |          | there meaningful alternatives? | [answer] | [Y/N] |",
                "",
